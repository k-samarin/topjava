...
public class MealsUtil {
    ...
    public static List<MealTo> getFilteredTos(
        ...
        return filterByPredicate(
                meals,
                caloriesPerDay,
                meal -> DateTimeUtil.isBetweenOpen(meal.getDate(), startDate, endDate),
    ...
    public static List<MealTo> getFilteredTos(Collection<Meal> meals, int caloriesPerDay, LocalDate startDate, LocalDate endDate) {
        return filterByPredicate(meals, caloriesPerDay, meal -> DateTimeUtil.isBetweenOpen(meal.getDate(), startDate, endDate));
    }

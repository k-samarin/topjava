...
public class MealsUtil {
    ...
    public static final List<Meal> mealsFebruaryUser2 = Arrays.asList(
            ...
            new Meal(LocalDateTime.of(2020, Month.FEBRUARY, 10, 10, 12), "Кофе", 120)
    );

    public static final List<Meal> mealsJanuaryUser1 = Arrays.asList(
    ...
    public static final List<Meal> mealsJanuaryUser2 = Arrays.asList(
            new Meal(LocalDateTime.of(2020, Month.JANUARY, 30, 20, 0), "Ужин", 500),
            new Meal(LocalDateTime.of(2020, Month.JANUARY, 31, 0, 0), "Еда на граничное значение", 100)
    );

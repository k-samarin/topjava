...
<section>
    ...
    <form method="get" action="${rootUrl}/meals/filter">
        <dl>
    ...
    <hr/>
    <a href="${rootUrl}/meals/create"><spring:message code="meal.addMeal"/></a>
    <br><br>
    <table border="1" cellpadding="8" cellspacing="0">
        ...
        <c:forEach items="${requestScope.meals}" var="meal">
            ...
            <tr data-meal-excess="${meal.excess}">
                ...
                <td>${meal.calories}</td>
                <td><a href="${rootUrl}/meals/update?id=${meal.id}"><spring:message code="meal.update"/></a></td>
                <td><a href="${rootUrl}/meals/delete?id=${meal.id}"><spring:message code="meal.delete"/></a></td>
            </tr>
        </c:forEach>
    </table>
</section>
